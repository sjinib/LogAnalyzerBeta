...
public class TwsLogParserDeep {
	...
	// Choice(1)
	public static void parseTwsLoginSeqInfo(File twsLogFile) throws Exception {
		Scanner scanner = new Scanner(twsLogFile);

		String[] filter1 = { "SPLASH Creating screen",
				"SPLASH Connecting to server",
				"SPLASH Requesting startup parameters",
				"SPLASH Retrieving settings key", "SPLASH Loading resources",
				"SPLASH Initializing environment",
				"SPLASH Reading market rules", "SPLASH Reading settings file",
				"SPLASH Loading window factories",
				"SPLASH Initializing resources",
				"SPLASH Processing startup parameters",
				"SPLASH Loading order defaults",
				"SPLASH Initializing managers", "SPLASH Starting application",
				"SPLASH Closing screen and saving", "S3:", "Received login",
				"Saving settings", "factory settings", "Copying file",
				"Verifying saved file", "EventQueue-0] - CCP reported time:" };

		String[] filter2 = { "PROXY Failed to connect", "upload failed",
				"Login failed", "Failed token authentication", "S3: Error",
				"failed to save settings file",
				"verification failed for settings file", "Error parsing xml",
				"Error reading settings file" };

		String[] filter3 = { "Trading Login Handoff class",
				"SPLASH Close pressed", "Started auto log off",
				"Application exit", "Competition", "competition", "Competing",
				"User initiated exit session",
				"Crossing day in suspended state", "Day cross detected",
				"SYSTEM CLOCK HAS BEEN CHANGED BY USER" };
	...
	// Choice(2)
	public static void parseTwsSysRes(File twsLogFile) throws Exception {
		Scanner scanner = new Scanner(twsLogFile);
	...
	// Choice(6)
	public static void parseTwsMktData(File twsLogFile) throws Exception {
		Scanner scanner = new Scanner(twsLogFile);
	...
	// Choice(4)
	public static void parseTwsConn(File twsLogFile) throws Exception {
		Scanner scanner = new Scanner(twsLogFile);
		...
		String[] filter3 = { "creating socket failed", "java.net.SocketException:", ": Error connecting", "connection error,", "DISCONNECT_ON_BROKEN_SOCKET", "DISCONNECT_ON_CONNECTION_FAILURE", "DISCONNECT_AUTHORIZATION_FILED", "NO_PING_RESPONSE", "NO_AUTH_RESPONSE" };		
	...
	// Choice(9)
	public static void parseTwsHtbp(File twsLogFile) throws Exception {
		Scanner scanner = new Scanner(twsLogFile);
	...
	// Choice(7)
	public static void parseTwsApi(File twsLogFile) throws Exception {
		Scanner scanner = new Scanner(twsLogFile);
	...
	// Choice(5)
	public static void parseTwsOrderTrds(File twsLogFile) throws Exception {
		Scanner scanner = new Scanner(twsLogFile);
